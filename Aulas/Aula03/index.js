...
console.log(`${estilos.negrito}${cores.cinza}A soma das notas é de ${cores.verde}${somaNotas}${cores.limpa}`)


console.log(`${cores.cinza}${estilos.negrito}E a média das notas entre os alunos é de ${cores.azul}${media}${cores.limpa}`)
