...
// Variáveis de apoio
const terreno = "Estrutura de um map()";
const separadorSuperior = "===".repeat(5);
const separadorInferior = "===".repeat(11) + "=";
...
// Execução do Print
console.log(`${estilos.negrito}${cores.vermelho}${separadorSuperior}${cores.cinza}MAP${cores.azul}${separadorSuperior}${cores.limpa}`);
