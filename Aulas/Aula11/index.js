...
console.log(`${cores.cinza}${estilos.negrito}As novas notas são ${cores.amarelo}${novasNotas}`);


console.log(`${cores.cinza}${estilos.negrito}As notas originais são ${cores.ciano}${notas}`);
