...
// Variáveis de apoio
const terreno = "Aprendendo sobre objetos";
...
// Execução do Print
console.log(`${estilos.negrito}${cores.vermelho}${separadorSuperior}${cores.cinza}Objetos${cores.azul}${separadorSuperior}${cores.limpa}`);
...
console.log(`${cores.cinza}${estilos.negrito}Os 3 primeiros digitos do cpf são ${cores.azul}${cliente.cpf.substring(0, 3)}${cores.limpa}`) 
