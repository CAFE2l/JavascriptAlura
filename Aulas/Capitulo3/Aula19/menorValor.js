...
// Variáveis de apoio
const terreno = "Biblioteca aviaras";
...
// Execução do Print
console.log(`${estilos.negrito}${cores.vermelho}${separadorSuperior}${cores.cinza}Biblioteca${cores.azul}${separadorSuperior}${cores.limpa}`);
